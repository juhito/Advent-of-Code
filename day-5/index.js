/* DAY 5
   ...
   They tend to form in lines; the submarine helpfully produces a list of neaby lines of vents (your puzzle input) for you
   ...
   line segment and x2,y2 are the coordinates of the other end. These line segments include the points at both ends.
   In other words:
...
const data = fs.readFileSync("input.txt", { encoding: "utf-8" })
      .split("\n")
      .map(e => e.split(/[^\d]+/).map(num => parseInt(num, 10)));
